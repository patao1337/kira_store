...
const Header = () => {
  return (
    <header className="bg-gradient-to-br from-[#F2DC00] to-[#F2DC00]/80 pt-10 md:pt-24 overflow-hidden">
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <section className="max-w-frame px-4">
          ...
          >
            Ми не просто продаємо речі — ми допомагаємо знайти те, що пасує саме вам. 
            Вибирайте з сотень брендів і тисяч якісних позицій, щоб створити стиль, 
            у якому вам комфортно й упевнено.
          </motion.p>
          <motion.div
            initial={{ y: "100px", opacity: 0 }}
            whileInView={{ y: "0", opacity: 1 }}
          ...
          >
            ...
            <div className="flex flex-col ml-6 md:ml-0">
              ...
              <span className="text-xs xl:text-base text-black/60">
                речей, які хочеться носити щодня
              </span>
            </div>
            <Separator
            ...
            <div className="flex flex-col w-full text-center sm:w-auto sm:text-left mt-3 sm:mt-0 sm:ml-6 md:ml-0">
              <span className="font-bold text-2xl md:text-xl lg:text-3xl xl:text-[40px] xl:mb-2">
                <AnimatedCounter from={0} to={30000} />+
              </span>
              <span className="text-xs xl:text-base text-black/60">
                клієнтів, які вже обрали нас
              </span>
            </div>
          </motion.div>
        </section>
        <motion.section
          ...
          className="relative md:px-4 min-h-[448px] md:min-h-[428px] bg-cover bg-center xl:bg-[center_top_-10rem] bg-no-repeat bg-[url('/images/header-res-homepage.png')] md:bg-[url('/images/header-homepage.png')]"
        >
          <Image
            priority
